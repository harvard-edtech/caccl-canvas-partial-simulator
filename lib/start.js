...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var canvasHost, appName, courseId, teacherAccessToken, taAccessTokens, studentAccessTokens, app, teacherAPI, teacherProfile, _a, studentObjects, profile, teacherId, i, err_1, teacher, studentAPIs, studentProfiles, err_2, students, taAPIs, taProfiles, err_3, tas;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                _a = _d.sent(), studentObjects = _a[0], profile = _a[1];
            ...
            case 13:
                ...
                app.get("/courses/:courseId/external_tools/".concat(CACCL_SIM_TOOL_ID_1.default, "?display=borderless"), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
