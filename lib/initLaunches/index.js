...
var initLaunches = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var app, appName, courseId, teacher, tas, students, _a, customParams, _b, customLaunchPaths;
    return __generator(this, function (_c) {
        app = opts.app, appName = opts.appName, courseId = opts.courseId, teacher = opts.teacher, tas = opts.tas, students = opts.students, _a = opts.customParams, customParams = _a === void 0 ? {} : _a, _b = opts.customLaunchPaths, customLaunchPaths = _b === void 0 ? [] : _b;
        /* --------------------------- Routes --------------------------- */
        /**
         * Simulator homepage
         * @author Gabe Abrams
        ...
        app.get('/simulator/users/:userId/launch', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, teacher.api.course.app.addByXML({
                                courseId: courseId,
                                name: uniqueAppName,
